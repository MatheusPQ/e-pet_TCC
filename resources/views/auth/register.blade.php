            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="nivel" class="col-md-4 col-form-label text-md-right">Você é</label>

                            <div class="col-md-6">
                                <select name="nivel" class="form-control">
                                    <option value="3">Sou usuário</option>
                                    <option value="2">Sou dono(a) de um petshop</option>
                                </select>
